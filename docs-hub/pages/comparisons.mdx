...
| **Security** | SOC 2 Type II | Basic | Basic | None | Basic |
...
**Enterprise Security**: SOC 2 Type II compliance with:
...
| **Enterprise** | SOC 2 Type II compliance | Developer-focused |
...
| **Compliance** | SOC 2 Type II | None/Basic |
...
- SOC 2 or compliance-driven environments
