...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>4</td>
      <td>Opus</td>
      <td>Chief of Staff, CPO, CFO, CRO — strategy, budget, quality bar (you set direction, NEXUS executes)</td>
    </tr>
    <tr>
      <td><strong>Management</strong></td>
      <td>5</td>
      <td>Opus/Sonnet</td>
      <td>VP Engineering, Tech Lead, Engineering Managers — architecture, coordination</td>
    </tr>
    <tr>
      <td><strong>Senior</strong></td>
      <td>4</td>
      <td>Sonnet</td>
      <td>Senior frontend, backend, full-stack, DevOps engineers — code review, design systems</td>
    </tr>
    <tr>
      <td><strong>Implementation</strong></td>
      <td>6</td>
      <td>Sonnet</td>
      <td>Frontend, backend, full-stack, DevOps developers, performance engineer</td>
    </tr>
    <tr>
      <td><strong>Quality</strong></td>
      <td>4</td>
      <td>Sonnet/Haiku</td>
      <td>QA lead, test engineers, linting agent — quality gates</td>
    </tr>
    <tr>
      <td><strong>Consultant</strong></td>
      <td>4</td>
      <td>Opus/Gemini/o3/Haiku</td>
      <td>Security, UX, systems architecture, cost optimization</td>
    </tr>
  </tbody>
</table>
